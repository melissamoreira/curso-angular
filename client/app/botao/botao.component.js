...
var BotaoComponent = (function () {
    function BotaoComponent() {
        this.nome = 'OK'; //Texto do botão
        this.estilo = 'btn-default'; //Classes CSS
        this.tipo = 'button'; //'type'
        this.desabilitado = false; //'disabled'
        this.confirmacao = false; //Se requer confirmação
        this.acao = new core_1.EventEmitter(); //Evento
    }
